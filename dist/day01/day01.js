const input = require('fs').readFileSync('src/day01/day01.txt', 'utf8').split('\n')[0];
...
const matchingPairsSum = pairs => pairs.filter(pairIsEqual).reduce((sum, pair) => sum += sumOfPair(pair), 0);
